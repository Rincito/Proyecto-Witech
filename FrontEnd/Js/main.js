document.addEventListener("DOMContentLoaded", function () {
  ...
  function inicializarHeader() {
    ...
    function registrarUsuario(email, password, code) {
      // Si estamos en el primer paso, enviamos el código
      if (!isVerifyingCode) {
        fetch("../../BackEnd/api/send-verification-code", {
          method: "POST",
          headers: {
        ...
        // En el segundo paso: verificamos el código y registramos
        fetch("../../BackEnd/api/verify-code", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
